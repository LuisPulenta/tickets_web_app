...
class TicketCabsDerivatedDTS extends DataTableSource {
  final List<TicketCab> ticketCabsDerivated;
  final BuildContext context;

  TicketCabsDerivatedDTS(this.ticketCabsDerivated, this.context);

  @override
  DataRow getRow(int index) {
    final ticketCab = ticketCabsDerivated[index];
  ...
  @override
  int get rowCount => ticketCabsDerivated.length;
