...
class TicketCabsOkDTS extends DataTableSource {
  final List<TicketCab> ticketCabsOk;
  final BuildContext context;

  TicketCabsOkDTS(this.ticketCabsOk, this.context);

  @override
  DataRow getRow(int index) {
    final ticketCab = ticketCabsOk[index];
  ...
  @override
  int get rowCount => ticketCabsOk.length;
